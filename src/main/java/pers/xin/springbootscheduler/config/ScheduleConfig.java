package pers.xin.springbootscheduler.config;
...
/*	@Override
	...
	public TaskScheduler taskScheduler() {
		...
		taskScheduler.setPoolSize(5);// 配置线程池大小，根据任务数量定制
		taskScheduler.setThreadNamePrefix("my-spring-task-scheduler-thread-");// 线程名称前缀
